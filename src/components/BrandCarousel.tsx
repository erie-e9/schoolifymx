...
const UNIFORM_BRANDS = [
  ...
  { name: 'Modatelas', logo: '', link: 'https://www.modatelas.com.mx' },
...
const SHOE_BRANDS = [
  ...
  { name: 'Nike', logo: '', link: 'https://www.nike.com/mx' },
  { name: 'Adidas', logo: '', link: 'https://www.adidas.com.mx' },
  { name: 'Puma', logo: '', link: 'https://www.puma.com/mx' },
  { name: 'Flexi', logo: '', link: 'https://www.flexi.com.mx' },
...
const BrandCarousel: React.FC<BrandCarouselProps> = ({ activeService = 'supplies', shoeMode = false }) => {
