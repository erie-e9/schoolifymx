...
const Tooltip: React.FC<TooltipProps> = ({ content }) => {
  return (
    <div className="group relative whitespace-nowrap z-[100] ml-1.5 inline-flex cursor-pointer">
      ...
      <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 w-max max-w-[165px] whitespace-normal bg-gray-900 text-white text-[10px] font-body p-2 rounded opacity-100 group-hover:opacity-100 group-hover:visible transition-all shadow-xl pointer-events-none z-[110]">
        {content}
