...
const FAQItem: React.FC<FAQItemProps> = React.memo(({ item, index }) => {
  ...
  return (
    ...
    >
      <button
        className="w-full flex items-center justify-between gap-4 px-5 py-5 md:px-6 md:py-6 text-left active:bg-gray-50/50 dark:active:bg-dark-bg/50 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 dark:focus-visible:ring-offset-dark-bg"
      ...
      <div ref={contentRef} id={`faq-content-${index}`} className="overflow-hidden" style={{ height: 0, opacity: 0 }} role="region">
