...
const logos = [
  { name: 'Colegio Excelsior', emoji: '🏫', link: '#' },
  { name: 'Instituto Morales', emoji: '📚', link: '#' },
  { name: 'Primaria San Pablo', emoji: '✏️', link: '#' },
  { name: 'Secundaria Cervantes', emoji: '🎒', link: '#' },
  { name: 'Kinder Arcoíris', emoji: '🌈', link: '#' },
  { name: 'Prepa Alfa', emoji: '🎓', link: '#' },
  { name: 'I. Montessori MX', emoji: '🌟', link: '#' },
  { name: 'Colegio Británico', emoji: '🇬🇧', link: '#' },
];
  ...
  return (
    <section className="py-20 bg-surface dark:bg-dark-bg overflow-hidden transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 mb-12 text-center">
        <Badge variant="secondary" className="mb-4">Confianza comprobada</Badge>
        <h2 className="text-4xl md:text-5xl font-heading font-900 mb-4 dark:text-dark-text tracking-tight">
